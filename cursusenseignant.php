...
$select_stmt = $db->prepare("SELECT * FROM cursusEnseignant");
$select_stmt->execute();

?>
<div class="container">
    <h2 class="text-warning text-center mt-5 mb-3">Cursus attribués</h2>
    <br>
    <?php
...
<?php
        ...
        echo "<br><br><div class='text-center text-danger'><p>Aucun cursus attibué</p></div>";
    }
?>
</body>
</html>

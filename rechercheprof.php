...
if (isset($_POST['recherche'])) {
    ...
    $select_stmt = $db->prepare("SELECT username, email, status FROM p2_g3_comptes WHERE type='enseignant' AND username LIKE '%$recherche%' OR type='enseignant' AND email LIKE '%$recherche%' OR type='enseignant' AND status LIKE '%$recherche%'");
    $select_stmt->execute();

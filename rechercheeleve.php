...
if (isset($_POST['recherche'])) {
    ...
    $select_stmt = $db->prepare("SELECT username, email, status FROM p2_g3_comptes WHERE type='eleve' AND username LIKE '%$recherche%' OR type='eleve' AND email LIKE '%$recherche%' OR type='eleve' AND status LIKE '%$recherche%'");
    $select_stmt->execute();
